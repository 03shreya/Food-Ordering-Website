...
$db = mysqli_connect('localhost','root','','recharge')
...
if(isset($_POST['Login']))
{
   ...
   $fname=$_POST['Name'];
    ...
    $query=mysqli_query("insert into register (Name,EmailId,PhoneNo,Password) values ('$fname','$email','$phone','$password')");
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form">
                    ...
                    <div>
                            <a href="https://punjab.chitkara.edu.in//Interface/forgot.php" class="txt1">
                                Forgot Password? 
                            </a>
                        </div>
</div>
