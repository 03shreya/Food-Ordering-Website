...
mysqli_connect('localhost','root','','recharge')
...
<body>
    ...
    <div class="limiter">
        <div class="container-login100">
            ...
            <form name="form1" action="signup.php" class="login100-form validate-form">
                    ...
                    <div class="flex-sb-m w-full p-b-30">
                        ...
                        <INPUT type="submit" class="login100-form-btn" onClick="return validateForm()" value="Submit">
                    </div>
                </form>
            </div>
        </div>
